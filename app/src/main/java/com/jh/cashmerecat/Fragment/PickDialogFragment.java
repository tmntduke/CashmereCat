...
public class PickDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        if (sOnDoOptionOnDialog != null) {
            takePhoto.setOnClickListener(v -> sOnDoOptionOnDialog.onTakePhoto(v));

            photo.setOnClickListener(v -> sOnDoOptionOnDialog.onChoosePhoto(v));

            cancel.setOnClickListener(v -> sOnDoOptionOnDialog.onCancel(v));
        }
